...
# $Id: interface.tcl,v 1.18 2002-04-02 16:14:03 amirs Exp $
...
proc xchatter_ui {root args} {
    ...
    listbox $base.userlist -width 0 \
		-yscrollcommand "$base.userlist_scrollbar set"

    scrollbar $base.userlist_scrollbar \
    	-command "$base.userlist yview" \
	-orient v
    ...
    grid $base.userlist_scrollbar -in $base.mainframe -row 1 -column 4 -sticky nesw
